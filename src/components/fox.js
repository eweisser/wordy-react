    ...
    return (
        <div id="fox">
            <svg width="100%" height="100%" viewBox="0 0 800 750">
                ...
                <path d="M 279 425 c 31 3 34 25 32 35" stroke="#830" stroke-width="20" stroke-linecap="round" fill="none" name="left eye"/>
                <path d="M 521 425 c -31 3 -34 25 -32 35" stroke="#830" stroke-width="20" stroke-linecap="round" fill="none" name="right eye"/>
            </svg>
        </div>
    );
}
